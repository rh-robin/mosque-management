...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('backend/assets/images/image-not.png') }}">
                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index.html" class="d-inline-block auth-logo">
                                <img src="{{ asset('backend/assets/images/image-not.png') }}" alt="" height="100">
                            </a>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy;
                            <script>document.write(new Date().getFullYear())</script>. Crafted with <i class="mdi mdi-heart text-danger"></i> by {{ config('app.name') }}
                        </p>
                    </div>
                </div>
            </div>
